/******************************************************************************
 * C++ source of oe-802.22-fm
 *
 * File:   OE-802.22-fm.cpp
...
int main(int argc, char *argv[])
{
    if (argc == 1)
    {
        ...
        cout << endl;
        cout << "type \033[36m'oe-802.22-fm help'\033[0m to see all options !" << endl;
    }
    else if (argc >= 2)
    {
        for (int c = 0; c < argc; c++)
        {
            ...
            case 1:
                ...
                {
                    cout << "Options for starting WRAN: oe-802.22-tx-tone \033[36mMODE CENTER-FREQUENCY GAIN TONE-FREQUENCY MODULATION-FACTOR DURATION\033[0m" << endl;
                    cout << endl;
                ...
                {
                    cout << "Wrong settings, please type  \033[36m'oe-802.22-fm help'\033[0m to see all options !" << endl;
                    return 0;
                }
                break;
    ...
    {
        msg.str("");
        msg << "Start transmitting FM tone at " << centerFrequency / 1000000 << " MHz.";
        serialPuts(serial_port, msg.str().c_str());
    }
