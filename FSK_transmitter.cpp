    ...
    else if (argc >= 2)
    {
        for (int c = 0; c < argc; c++)
        {
            ...
            case 1:
                ...
                {
                    cout << "Options for starting WRAN: multiple_PHY_modes \033[36mMODE CENTER-FREQUENCY GAIN SUBCARRIERS DATA-CARRIERS PHY_MODE CYCLIC_PREFIX PAYLOAD\033[0m" << endl;
                    cout << endl;
                    ...
                    cout << endl;
                    cout << "\033[36mPAYLOAD033[0m:" << endl;
                    cout << "     string" << endl;
                    cout << endl;
                    return 0;
                }
